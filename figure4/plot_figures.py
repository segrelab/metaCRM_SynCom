...
if __name__ == "__main__":
    ...
    #PLOT ALL FIGURES
    col_order = plot_Mfig_4a(exp_a_reps, outfile=os.path.join(args.out, "Mfig_4a_a.pdf"))
    plot_whole_community_exp2(exp_b_reps, col_order, outfile=os.path.join(args.out, "Mfig_4a_b.pdf"))
