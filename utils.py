...
def t0_wc_data(path='./data/exp_whole_comm/df_b_reps.csv'):
...
def cn_16s(path='./data/16s_cn.csv'):
...
def od_to_cfu(path='./data/od_cfu_counts.csv'):
    "Import OD-to-CFU Data (generated by Kendall)"
    name_to_sp = {v: k for k, v in utils.sps_to_name.items()}
    ...
    od_cfu = means.reindex(utils.sps_names, fill_value=1e9)
